        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl">
          <div className="md:flex">
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/90">236 5th SE Avenue, New York NY10000, United States</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/90">Mobile: +(84) 546-6789</p>
                    <p className="text-white/90">Hotline: +(84) 456-6789</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/90">Monday-Friday: 9:00 - 22:00</p>
                    <p className="text-white/90">Saturday-Sunday: 9:00 - 21:00</p>
                  </div>
                </div>
              </div>
            ...
            <div className="md:w-3/5 p-10">
              ...
              {submitted ? (
                <div className="text-center p-6 rounded-lg border-2 border-green-500 bg-green-50 animate-fade-in">
